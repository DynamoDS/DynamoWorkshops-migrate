  ...
  class UnfancifyViewModel : NotificationObject, IDisposable
  {
    ...
    public void UnfancifyGraph()
    {
      ...
      if (UngroupAll)
      {
        ...
        // Create a allowedList of prefixes for group titles from what was entered by the user in the UI
      ...
      if (DeleteTextNotes)
      {
        ...
        GeneralUtils.ClearSelection();
        // Create a allowedList of prefixes for text note content from what was entered by the user in the UI
